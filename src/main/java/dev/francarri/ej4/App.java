...
import dev.francarri.ej4.excepciones.CupoExcedidoException;
import dev.francarri.ej4.hilos.EnvioTicketsThread;
...
import dev.francarri.ej4.modelo.Sala;
import dev.francarri.ej4.modelo.actividades.Charla;
import dev.francarri.ej4.modelo.actividades.Curso;
import dev.francarri.ej4.modelo.actividades.Taller;
...
public class App{
    ...
    public static void main(String[] args) throws CupoExcedidoException {
        ...
        EnvioTicketsThread envioTicketsThread = new EnvioTicketsThread(evento);
        envioTicketsThread.setDaemon(true);
